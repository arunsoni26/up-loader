<main class="col-md-12 ms-sm-auto col-lg-12 px-md-4 mt-4 mb-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Permissions for <b style="color:crimson;">{{ ucfirst($user->name) }}</b></h1>
    </div>

    <div class="alert alert-light">
        <h6 class="mb-0"><i class="bi bi-info-circle-fill"></i> Toggle the switches to grant or revoke access for this user.</h6>
    </div>

    <form id="saveUserPermission" method="POST">
        @csrf
            ...
            <tbody>
                @foreach($modules as $module)
                    @php
                        ...
                        $existing = $userPermissions->firstWhere('module_id', $module->id);
                    @endphp
                    <tr>
...
<script>
    var formElement = document.getElementById('saveUserPermission');
